...
public class Book {
    ...
    public boolean authorsNotAvail() {
        String authorsString = mAuthors.toString();
        if (authorsString.contains("Not available")){
            return true;
        }
        return false;
    }

    public boolean publisherNotAvail() {
        if (mPublisher.contains("Not available")){
            return true;
        }
        return false;
    }
